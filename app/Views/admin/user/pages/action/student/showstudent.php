		...
		<div class="col-12">
			...
			<form class="file-upload" enctype="multipart/form-data">
				...
				<div class="gap-3 d-md-flex justify-content-md-center text-center">
					<a type="button" href="edit/<?= $show['id'] ?>" class="btn btn-primary btn-lg mx-auto d-block">Cập nhật thông tin</a>
					<a type="button" href="delete/<?= $show['id'] ?>" class="btn btn-danger btn-lg mx-auto d-block">Xóa hồ sơ</a>
				</div>
				<?php endif; ?>
				</div> <!-- Row END -->
