          ...
          <div class="col-md-12">
            ...
            <hr>
             <div class="d-flex align-items-center">
              <form class="d-flex" method="GET" action="<?= $url = route_to('search_if') ?>">
          ...
          <div class="col-md-12 mb-3">
            <div class="card">
              <div class="card-header">
                ...
                <a type="button" href="<?= $url = route_to('export_v') ?>" class="btn btn-success small-button mr-auto">Xuất thống kê</a>
                </span>
              </div>
              <div class="card-body">
                  ...
                  >
                    ...
                    <tbody>
                      ...
                      <tr class="centered-cell">
                        ...
                        <td>
                           <a type="button" href="tk_show/<?= $item['id'] ?>" class="btn btn-primary small-button">Xem</a>
                        </td>
                      </tr>
                    </tbody>
                  <?php endforeach; ?>
