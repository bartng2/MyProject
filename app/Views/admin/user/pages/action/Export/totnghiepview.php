          ...
          <div class="col-md-12">
            ...
            <hr>
             <div class="d-flex align-items-center">
              <form class="d-flex" method="GET" action="<?= $url = route_to('search_tn') ?>">
          ...
          <div class="col-md-12 mb-3">
            <div class="card">
              <div class="card-header">
                ...
                <a type="button" href="<?= $url = route_to('export_v2') ?>" class="btn btn-success small-button mr-auto">Xuất thống kê</a>
                </span>
              </div>
              <div class="card-body">
